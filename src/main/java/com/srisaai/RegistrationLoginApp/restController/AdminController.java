package com.srisaai.RegistrationLoginApp.restController;
...
import com.srisaai.RegistrationLoginApp.service.interfaces.TokenService;
import com.srisaai.RegistrationLoginApp.Token.GenerateToken;
...
public class AdminController {
	...
	public int saveAdminDetail(@RequestBody AdminDetail adminDetail) {
		System.out.println("saveAdminController by main");
	...
	{
		System.out.println("In login Controller just added.........");
		int status;
		...
		if (status > 0) 
		{
			 ...
			 * Generate token.
			 */
			String tokenData[] = generateToken.createJWT(adminDetail.getEmailId(), "srisaai", "JWT Token",
